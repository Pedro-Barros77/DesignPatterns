using ChainOfResponsibility.Solution.Handlers;
...
{
    using IMessageHandler = IHandler<SendMessageRequest, Task<SendMessageResponse>>;
    ...
    public static class MessagingService
    {
        ...
        public static async Task HandleMessaging()
        {
            ...
            var handler = new MessageFormValidationHandler();

            handler.SetNext(new MessageAccessValidationHandler())
                .SetNext(new MessageSpamValidationHandler())
                .SetNext(new MessageBannedWordsValidationHandler())
                .SetNext(new MessageContactValidationHandler())
                .SetNext(new MessageModeratorCommandValidationHandler())
                .SetNext(new MessageSentHandler());
        ...
        private static async Task Send(SendMessageRequest request, IMessageHandler handler)
        {
        ...
        private static async Task SendFormValidationTests(IMessageHandler handler)
        {
        ...
        private static async Task SendAccessValidationTests(IMessageHandler handler)
        {
        ...
        private static async Task SendSpamValidationTests(IMessageHandler handler)
        {
            WriteColored("", 1);
        ...
        private static async Task SendBannedWordValidationTests(IMessageHandler handler)
        {
        ...
        private static async Task SendContactValidationTests(IMessageHandler handler)
        {
        ...
        private static async Task SendModeratorCommandTests(IMessageHandler handler)
        {
