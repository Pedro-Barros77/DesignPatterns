...
{
    public class ComplexObject : IComplexObject//, IPrototype<ComplexObject>
    {
        ...
        private ComplexObject(ComplexObject prototype)
        {
            PublicText = prototype.PublicText;
            PublicNumber = prototype.PublicNumber;
            PublicList = new(prototype.PublicList);
            BooleanNotInConstructor = prototype.BooleanNotInConstructor;
            PublicTextPrivateSet = prototype.PublicTextPrivateSet;
            PrivateText = prototype.PrivateText;
            PrivateReadOnlyText = prototype.PrivateReadOnlyText;
        }

        public IComplexObject Clone()
        {
